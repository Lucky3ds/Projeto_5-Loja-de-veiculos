$(function(){
	...
	// criando slider da página individual da vitrine
	...
	// foto destaque = background-image;
		...
		// fazer os scrollTop usando o atributo\\

        var directory = '/Lúcio/Documents/Lucas-Backup/Curso%20Webmaster/Projetos/projeto_05/'
        ...
        //Sistema de slide do depoimento\\

        var amtDepoimento = $('.depimento-single p').length;
        var curIndex = 0;
        iniciarDepoimentos();
        navegarDepoimentos();
